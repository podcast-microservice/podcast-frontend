...
import BestSellerBlock from '~/features/kidsplaza/components/best-seller';
import SwiperWithCustomArrow from '~/features/kidsplaza/components/slider-with-custom-arrow';
import ProductSpotlight from '~/features/kidsplaza/components/spotlight-product';
    ...
    return (
        <>
            <main className='tw-px-[10%] tw-py-[5%] tw-bg-blue-100'>
                ...
                <div className='tw-mt-10 tw-flex tw-flex-wrap tw-items-center tw-gap-3 tw-mb-10'>
                    <FilterRangeProduct
                ...
                <div className='tw-h-40 tw-w-[698px] lg:tw-w-[950px] xl:tw-w-[1304px]'>
                    <SwiperWithCustomArrow
                        slidesPerView={3}
                        spaceBetween={20}
                        className='tw-h-full'
